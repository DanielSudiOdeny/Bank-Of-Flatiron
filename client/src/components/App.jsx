...
const App = () => {
  ...
  return (
    <div className="flex relative justify-between flex-col h-screen">
      <div>
        <div className="bg-gray-200 fixed top-0 z-10 w-full">
          <Header />
          <SearchBar setShowMyModal={setShowMyModal} />
        </div>
      ...
      <div className="md:hidden bg-blue-50  sticky bottom-0 flex justify-center items-center m-2 text-sky-50 ">
        <button
